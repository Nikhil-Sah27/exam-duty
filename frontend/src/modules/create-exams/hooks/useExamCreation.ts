...
export function useExamCreation() {
  ...
  return {
    ...
    handleSetShareableMark: rooms.handleSetShareableMark,
    handleAddGlobalShared: rooms.handleAddGlobalShared,
    handleRemoveGlobalShared: rooms.handleRemoveGlobalShared,
